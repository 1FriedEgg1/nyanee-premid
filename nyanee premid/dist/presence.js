...
presence.on("UpdateData", async () => {
    ...
    if (document.location.pathname.includes("/watch")) {
        ...
        presenceData.state = ("Viewing profile of: " + document.querySelector("#banner-contents-profile > div > div.side-cont > div.userinfo-and-links > div > div.username").textContent);
    }
